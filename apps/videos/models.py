...
class Video(AbstractBaseModel):
    ...
    category = models.ForeignKey(Categories, models.CASCADE, related_name="video_categories")
...
class VideoLike(AbstractBaseModel):
    users = models.ForeignKey(UserProfile, models.DO_NOTHING, related_name="video_likes")
